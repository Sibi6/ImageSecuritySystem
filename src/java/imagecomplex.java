...
public class imagecomplex extends javax.servlet.http.HttpServlet implements  
   ...
   public void doPost(HttpServletRequest request, 
	...
	getServletContext().getRequestDispatcher("/complexencrypt.jsp").forward(request, response);   
